<ul class="space-y-2 mt-4">
    ...
    <li>
        <a href="#"
           class="flex items-center gap-4 p-4 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <li>
        <a href="<?= $this->Url->build(['controller' => 'news', 'action' => 'index']) ?>"
           class="flex items-center gap-4 p-4 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 bg-blue-100">
