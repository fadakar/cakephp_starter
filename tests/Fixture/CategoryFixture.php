...
class CategoryFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lft' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '10', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'rght' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '10', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'category_title' => ['type' => 'index', 'columns' => ['title'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'rght' => 1,
                'parent_id' => 1,
                'created' => '2022-09-18 11:03:46',
                'modified' => '2022-09-18 11:03:46',
            ],
        ];
        parent::init();
    }
